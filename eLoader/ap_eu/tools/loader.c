...
void _start()
{
	SceUID UserSbrkUID = *(SceUID*)0x0899D5B8;
	sceKernelFreePartitionMemory(UserSbrkUID);
	SceUID TheEngineSemaphore = *(SceUID*)0x0907C6DC;
	sceKernelSignalSema(TheEngineSemaphore, -1);
#ifdef RESET_HOME_SCREEN_LANGUAGE
	// Reset language and button assignment for the HOME screen to system defaults
